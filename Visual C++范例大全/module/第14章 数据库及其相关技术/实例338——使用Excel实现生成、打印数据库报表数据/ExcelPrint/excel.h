...
class FontNew : public COleDispatchDriver
{
public:
	FontNew() {}		// Calls COleDispatchDriver default constructor
	FontNew(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	FontNew(const FontNew& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
