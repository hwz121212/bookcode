...
ex25aDlg.h, ex25aDlg.cpp - the dialog
    These files contain your CEx25aDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in ex25a.rc, which can be edited in Microsoft
	Developer Studio.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CEx25aDlgAutoProxy class.  This class
