// ntBlockClientDlg.cpp : implementation file
//

#include "stdafx.h"
#include "ntBlockClient.h"
#include "ntBlockClientDlg.h"
...
/////////////////////////////////////////////////////////////////////////////
// CntBlockClientDlg dialog

CntBlockClientDlg::CntBlockClientDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CntBlockClientDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CntBlockClientDlg)
...
void CntBlockClientDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CntBlockClientDlg)
...
BEGIN_MESSAGE_MAP(CntBlockClientDlg, CDialog)
	//{{AFX_MSG_MAP(CntBlockClientDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CntBlockClientDlg message handlers

BOOL CntBlockClientDlg::OnInitDialog()
{
...
void CntBlockClientDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CntBlockClientDlg::OnPaint() 
{
	if (IsIconic())
	{
...
HCURSOR CntBlockClientDlg::OnQueryDragIcon()
{
...
void CntBlockClientDlg::OnTimer(UINT_PTR nIDEvent)
{
