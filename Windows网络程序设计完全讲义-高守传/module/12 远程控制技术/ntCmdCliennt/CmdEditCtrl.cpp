...
DWORD CCmdEditCtrl::ReadThread(LPVOID lpParam)
{
...
{
	CCmdEditCtrl* pCmdedit=this;
	LPTHREAD_START_ROUTINE lpStartAddress=CCmdEditCtrl::ReadThread;
	HANDLE hThread;
	DWORD dwThreadId;
	hThread = CreateThread(NULL, 0, lpStartAddress, this, 0, &dwThreadId);
	if (hThread == NULL)
	{
