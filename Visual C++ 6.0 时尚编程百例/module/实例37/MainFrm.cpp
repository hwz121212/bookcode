...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	//设置状态栏窗格的风格
	//使第一个窗格具有立体边框,宽度为50
	m_wndStatusBar.SetPaneInfo(0,0,SBPS_POPOUT,50);
	//设置x坐标信息窗口宽度为70
	m_wndStatusBar.SetPaneInfo(1,ID_MY_STATUS_BAR,SBPS_POPOUT,70);
	//设置y坐标信息窗口宽度可伸缩
    m_wndStatusBar.SetPaneInfo(1,ID_MY_STATUS_BAR,SBPS_STRETCH,70);
