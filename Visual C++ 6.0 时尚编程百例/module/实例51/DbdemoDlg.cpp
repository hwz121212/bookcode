     ...
     ::SQLAllocHandle(SQL_HANDLE_STMT, hdbc, &hstmt)))
      ...
      (unsigned char*)szSQL, SQL_NTS)))
      {
       if (SQL_SUCCESS == (rc = ::SQLExecute(hstmt)))
       {
           ...
           SQLBindCol(hstmt,1,SQL_C_CHAR,szName,PERSON_INFO,(SQLLEN *)&cb);
		   SQLBindCol(hstmt,2,SQL_C_LONG,&personage,0, (SQLLEN *)&cb);
		   SQLBindCol(hstmt,3,SQL_C_CHAR,personsex,PERSON_INFO, (SQLLEN *)&cb);
