...
#ifndef ___AttributedATLSpaceShipSvr_h__
#define ___AttributedATLSpaceShipSvr_h__
...
#ifndef __IAttributedATLSpaceShip_FWD_DEFINED__
#define __IAttributedATLSpaceShip_FWD_DEFINED__
typedef interface IAttributedATLSpaceShip IAttributedATLSpaceShip;
#endif 	/* __IAttributedATLSpaceShip_FWD_DEFINED__ */
...
#ifndef __CAttributedATLSpaceShip_FWD_DEFINED__
#define __CAttributedATLSpaceShip_FWD_DEFINED__

#ifdef __cplusplus
typedef class CAttributedATLSpaceShip CAttributedATLSpaceShip;
#else
typedef struct CAttributedATLSpaceShip CAttributedATLSpaceShip;
#endif /* __cplusplus */

#endif 	/* __CAttributedATLSpaceShip_FWD_DEFINED__ */
...
#ifndef __IAttributedATLSpaceShip_INTERFACE_DEFINED__
#define __IAttributedATLSpaceShip_INTERFACE_DEFINED__

/* interface IAttributedATLSpaceShip */
/* [unique][helpstring][dual][uuid][object] */ 


EXTERN_C const IID IID_IAttributedATLSpaceShip;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("4B8685BD-00F1-4D38-AFC1-3012C786480D")
    IAttributedATLSpaceShip : public IDispatch
    {
    public:
    ...
    typedef struct IAttributedATLSpaceShipVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            IAttributedATLSpaceShip * This,
            /* [in] */ REFIID riid,
        ...
        END_INTERFACE
    } IAttributedATLSpaceShipVtbl;

    interface IAttributedATLSpaceShip
    {
        CONST_VTBL struct IAttributedATLSpaceShipVtbl *lpVtbl;
    };
...
#define IAttributedATLSpaceShip_QueryInterface(This,riid,ppvObject)	\
    (This)->lpVtbl -> QueryInterface(This,riid,ppvObject)

#define IAttributedATLSpaceShip_AddRef(This)	\
    (This)->lpVtbl -> AddRef(This)

#define IAttributedATLSpaceShip_Release(This)	\
    (This)->lpVtbl -> Release(This)


#define IAttributedATLSpaceShip_GetTypeInfoCount(This,pctinfo)	\
    (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo)

#define IAttributedATLSpaceShip_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo)

#define IAttributedATLSpaceShip_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)

#define IAttributedATLSpaceShip_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)


#define IAttributedATLSpaceShip_CallStarFleet(This,fStarDate,pbstrRecipient)	\
    (This)->lpVtbl -> CallStarFleet(This,fStarDate,pbstrRecipient)
...
/* [helpstring][id] */ HRESULT STDMETHODCALLTYPE IAttributedATLSpaceShip_CallStarFleet_Proxy( 
    IAttributedATLSpaceShip * This,
    /* [in] */ FLOAT fStarDate,
    /* [retval][out] */ BSTR *pbstrRecipient);


void __RPC_STUB IAttributedATLSpaceShip_CallStarFleet_Stub(
    IRpcStubBuffer *This,
...
#endif 	/* __IAttributedATLSpaceShip_INTERFACE_DEFINED__ */
...
#ifndef __AttributedATLSpaceShipSvr_LIBRARY_DEFINED__
#define __AttributedATLSpaceShipSvr_LIBRARY_DEFINED__

/* library AttributedATLSpaceShipSvr */
/* [helpstring][uuid][version] */ 


EXTERN_C const IID LIBID_AttributedATLSpaceShipSvr;

EXTERN_C const CLSID CLSID_CAttributedATLSpaceShip;

#ifdef __cplusplus

class DECLSPEC_UUID("CE07EBA4-0858-4A81-AD1C-C12710B4A1A2")
CAttributedATLSpaceShip;
#endif
#endif /* __AttributedATLSpaceShipSvr_LIBRARY_DEFINED__ */
