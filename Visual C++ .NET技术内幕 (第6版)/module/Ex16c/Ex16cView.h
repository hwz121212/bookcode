...
protected: // create from serialization only
	CEx16cView();
	DECLARE_DYNCREATE(CEx16cView)

public:
	enum{ IDD = IDD_EX16C_FORM };

// Attributes
public:
	CEx16cDoc* GetDocument() const;
...
#ifndef _DEBUG  // debug version in Ex16cView.cpp
inline CEx16cDoc* CEx16cView::GetDocument() const
   { return reinterpret_cast<CEx16cDoc*>(m_pDocument); }
#endif
