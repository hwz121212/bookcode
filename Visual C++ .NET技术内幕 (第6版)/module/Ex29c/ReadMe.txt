========================================================================
    ACTIVE TEMPLATE LIBRARY : Ex29c Project Overview
========================================================================

AppWizard has created this Ex29c project for you to use as the starting point for
...
_Ex29c.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_Ex29c.h)
        GUID definitions                                (_Ex29c_i.c)
        A type library                                  (_Ex29c.tlb)
        Marshaling code                                 (_Ex29c_p.c and dlldata.c)
Ex29c.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named Ex29c.pch and a precompiled types file named StdAfx.obj.
...
Ex29cps.vcproj
	...
	dlldata.c, Ex29c_i.c and Ex29c_p.c which are required
