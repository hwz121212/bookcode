...
void CCube::OnLButtonDown( UINT nFlags, CPoint point )
{
	Point pt;
	pt.X = point.x;
	pt.Y = point.y;
...
void CCube::OnLButtonUp( UINT nFlags, CPoint point )
{
	Point pt;
	pt.X = point.x;
	pt.Y = point.y;
...
void CCube::OnMouseMove( UINT nFlags, CPoint point )
{
	Point pt;
	pt.X = point.x;
	pt.Y = point.y;
...
void CCube::SetStartPoint( Point point )
{
	m_ptEnd = m_ptStart = point;
}

void CCube::SetEndPoint( Point point )
{
	m_ptEnd = point;
}

void CCube::SetStartAndEndPoint( Point ptStart, Point ptEnd )
{
	m_ptStart = ptStart;
	m_ptEnd = ptEnd;
}

void CCube::DrawSelected( Graphics* graphics )
{
