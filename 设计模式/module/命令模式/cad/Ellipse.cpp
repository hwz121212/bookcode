...
void CEllipse::SetStartPoint( Point point )
{
	m_ptEnd = m_ptStart = point;
}

void CEllipse::SetEndPoint( Point point )
{
	m_ptEnd = point;
}

void CEllipse::SetStartAndEndPoint( Point ptStart, Point ptEnd )
{
	m_ptStart = ptStart;
	m_ptEnd = ptEnd;
}

void CEllipse::DrawSelected( Graphics* graphics )
{
